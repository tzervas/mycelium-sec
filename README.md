...
<!-- FLEET-BADGES:BEGIN -->
[![CI](https://github.com/tzervas/mycelium-sec/actions/workflows/fleet-ci.yml/badge.svg?branch=main)](https://github.com/tzervas/mycelium-sec/actions/workflows/fleet-ci.yml?query=branch%3Amain)
[![Security](https://github.com/tzervas/mycelium-sec/actions/workflows/fleet-security.yml/badge.svg?branch=main)](https://github.com/tzervas/mycelium-sec/actions/workflows/fleet-security.yml?query=branch%3Amain)
...
| **Source paths** | crates/mycelium-sec |
| **License** | MIT |
